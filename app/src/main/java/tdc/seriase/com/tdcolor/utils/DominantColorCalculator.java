...
import tdc.seriase.com.tdcolor.utils.MedianCutQuantizer.ColorNode;
...
public class DominantColorCalculator {
    ...
    private void findColors() {
        ...
        if (secondaryAccentColor != null) {
            secondaryColor = secondaryAccentColor.getRgb();
        }
...
//        return mWeightedPalette[1];
        return mWeightedPalette.length > 1 ? mWeightedPalette[1] : null;
    }
...
//        return ColorUtils.changeBrightness(secondary.getRgb(), 0.45f);
        return secondary == null ? Color.rgb(255, 255, 255) : ColorUtils.changeBrightness(secondary.getRgb(), 0.45f);
    }
